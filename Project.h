...
class Project
{
    ...
    public:
        ...
        void special_pyth_triplet();
        void summation_of_primes();           //10
        ...
        void factorial_digit_sum();           //20
        void names_score();
        void first_1000_digit_fibonacci();
        void trunctable_primes();             //23
...
// -------------------------/UTILITY FUNCTIONS/-------------------------------
        ...
        int maxTotal (int num1, int num2, int up);
        int checkPath(int num, int tri[][15]);
};
